...
/***/ function(module, exports, __webpack_require__) {
	...
	React.render(React.createElement(Message, {name: "Andrew"}), document.getElementById('content'));
	  ...
	  render: function() {
	    return (
	      React.createElement("div", null, 
	        ...
	        React.createElement(List, {data: dataList})
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(4),
	    Comp1 = __webpack_require__(8),
	    Comp2 = __webpack_require__(9);
	...
	var Button = React.createClass({displayName: "Button",
	  ...
	  render: function() {
	    return (
	      React.createElement("div", null, 
	        React.createElement("button", {onClick: this.incrementCount}, "Click me"), 
	        React.createElement(Comp1, null, "Component 1: ", this.state.count), 
	        React.createElement(Comp2, null, "Component 2: ", this.state.count)
	      )
	    );
	  }
	});
	  ...
	  render: function() {
	    return (
	      ...
	      this.props.data.map(function(result,i) {
	        return React.createElement("li", {key: i}, result.text)
	      })
	      )
	    );
	  }
